...
import { faEnvelope, faMap, faMouse, faLink, faHeart, faClock } from '@fortawesome/free-solid-svg-icons'
        ...
        return (
            <div>
                <div className="main">
                    ...
                    <div className="end">
                        <p className="end-text">Made with <FontAwesomeIcon icon={faHeart} /> and a lot of <FontAwesomeIcon icon={faClock} /> investment</p>
                    </div>
                </div>
            </div>
        )
